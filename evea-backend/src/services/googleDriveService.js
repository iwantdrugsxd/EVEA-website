...
6. Set up folder structure in Google Drive:
   - Create a folder for vendor documents
   - Create a folder for vendor media
   - Share these folders with your service account email
   - Note down the folder IDs from the URL

7. Environment Variables:
   GOOGLE_SERVICE_ACCOUNT_KEY_FILE=path/to/your/service-account-key.json
   VENDOR_DOCUMENTS_FOLDER_ID=your_documents_folder_id
   VENDOR_MEDIA_FOLDER_ID=your_media_folder_id
